...
export default {
  ...
  computed: {
    ...mapGetters('store', ['pendentEvents', 'events']),

    filteredEvents: function () {
      var self = this
      return this.pendentEvents.filter(function (event) { return event.eventName.toLowerCase().indexOf(self.search.toLowerCase()) >= 0 })
    }
  },

  mounted () {
    console.log(this.events)
    console.log(this.pendentEvents)
  }
}
</script>
